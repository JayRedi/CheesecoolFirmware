...
typedef enum { CMD_PING=1, CMD_GET_INFO=2, CMD_SET_FAN_DUTY=3, CMD_GET_FAN_STATUS=4, CMD_FAN_ENABLE=5, CMD_FAN_DISABLE=6, CMD_KEEPALIVE=7, CMD_RESERVED_08=8, CMD_GET_STATUS=9, CMD_SET_MODE=10, CMD_SET_DUTY=11, CMD_SET_CURVE=12, CMD_RESERVED_0D=13 } usb_command_t;
